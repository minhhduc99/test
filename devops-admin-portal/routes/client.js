...
router.post('/create', isAuth, attachCurrentUser, checkRole(['sadmin', 'admin']), controller.create_post);

// POST request for updating
router.post('/update', isAuth, attachCurrentUser, checkRole(['sadmin', 'admin']), controller.update_post);

// POST request for updating status
router.post('/updateStatus', isAuth, attachCurrentUser, checkRole(['sadmin', 'admin']), controller.update_status_post);

// GET request for listing
router.get('/', isAuth, attachCurrentUser, checkRole(['sadmin', 'admin']), controller.list_get);
